...
export const msalConfig: Configuration = {
  auth: {
    ...
    redirectUri: 'http://localhost:5173', // This should match the Azure app registration
...
export const microsoftAuthConfig = {
  ...
  redirect_uri: 'http://localhost:5173', // This should match the Azure app registration
